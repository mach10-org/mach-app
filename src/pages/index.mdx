...
<TitleDescriptionImage imageSrc="https://images.assetsdelivery.com/compings_v2/tokyovisionaryroom/tokyovisionaryroom2208/tokyovisionaryroom220800384.jpg" imagePosition="right" imageAlt="office feature image" addSeparator={true}>
...
<TitleDescriptionImage imageSrc="https://as2.ftcdn.net/v2/jpg/01/95/11/43/1000_F_195114322_p9YdJPKZUE5QQVbkP93BKxC4CGJ1nbNT.jpg" imagePosition="left" imageAlt="office feature image" addSeparator={true}>
...
<TitleDescription classes="sm:px-8 lg:px-32 xl:px-64" isCentered={true}>
  ...
  <Newsletter label="Email address" placeholder="Enter your email" buttonText="Apply now" description="Apply today, free forever. First course starting in 2023." inputId="email-newsletter-footer" client:only="vue" classes="mx-auto max-w-screen-sm mt-6" />
</TitleDescription>
