...
<TitleDescription classes="sm:px-8 lg:px-32 xl:px-64" isCentered={true}>
  ...
  <Newsletter label="Email address" placeholder="Enter your email" buttonText="Notify me" inputId="email-newsletter-home-footer" client:only="vue" classes="mx-auto max-w-screen-sm mt-6">
    <NoTag slot="description">We’ll notify you when our first course is ready. First course starting in 2023.</NoTag>
  </Newsletter>
</TitleDescription>
