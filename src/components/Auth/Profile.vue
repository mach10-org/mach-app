    ...
    <div class="flex flex-col items-center justify-center px-6 py-8 mx-auto">
      ...
      >
        <div class="p-6 space-y-4 md:space-y-6 sm:p-8">
          ...
          <h4>
            We’d love to learn more about you. Could you share with us what is your main goal
            applying here? Even if it’s just curiosity, we’re interested to hear ☺. <br />This is
            also helping us to know our audience and adapt our content accordingly.
          </h4>

          <p class="text-center mb-2 font-light text-gray-500 dark:text-gray-400">
            Update your profile !
          </p>
          ...
          <form class="space-y-4 md:space-y-6">
            <div>
              <label
                ...
                >Your firstname (how should we call you?)</label
              >
              <input
                type="text"
            ...
            <div>
              <label
                for="computer_xp"
                class="block mb-2 text-sm font-medium text-gray-900 dark:text-white"
                >Experience with computers</label
              >
              ...
              >
                ...
                <option value="I know how to use a computer but never did technical work">
            ...
            <div>
              <label for="goal" class="block mb-2 text-sm font-medium text-gray-900 dark:text-white"
                >What is your goal with this program?</label
              >
              <div class="grid grid-cols-2 gap-2">
                <div
                  v-for="(value, index) in goalsList"
            ...
            <div>
              <label
                for="about"
                class="block mb-2 text-sm font-medium text-gray-900 dark:text-white"
                >Could you tell us more about you and your objectives ?</label
              >
